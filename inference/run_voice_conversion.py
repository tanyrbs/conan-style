...
class VoiceConversionRunner:
    ...
    def setup_output_dir(self):
        ...
        self.output_dir = f"test_output_hifigan"
    ...
    def run_single_conversion(self, pair, pair_idx):
        ...
        try:
            ...
            # Run inference
            wav_pred, mel_pred = self.engine.infer_once(inp)
            
            # Save output with specified naming
            output_path = os.path.join(self.output_dir, pair['output_name'])
...
def main():
    ...
    runner.run_all_conversions(start_idx=0, end_idx=None, batch_size=50)
