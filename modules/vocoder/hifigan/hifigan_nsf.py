...
if not hasattr(scipy.signal, "kaiser") and hasattr(scipy.signal, "windows"):
...
try:
    ...
    from parallel_wavegan.layers.upsample import UpsampleNetwork, ConvInUpsampleNetwork
    from modules.vocoder.hifigan.source import SourceModuleHnNSF
import numpy as np
