...
class StyleControl(BaseTTSInfer):
    ...
    def example_run(cls):
        ...
        inp = {
            ...
            'pace': 'slow',
            'range_': 'high',
            'ref_name': "Chinese#ZH-Alto-1#Mixed_Voice_and_Falsetto#Just_Once#Control_Group#0000",
            'gen_name': "Chinese#ZH-Alto-1#Mixed_Voice_and_Falsetto#Just_Once#Control_Group#0000",
        }
