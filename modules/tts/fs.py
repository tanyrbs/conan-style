...
from modules.commons.conv import TextConvEncoder, ConvBlocks, CausalConvBlocks
...
from modules.commons.wavenet import WN,CausalWN
...
FS_DECODERS = {
    ...
    'conv': lambda hp: CausalConvBlocks(hp['hidden_size'], hp['hidden_size'], hp['dec_dilations'],
    ...
    'wn': lambda hp: CausalWN(hp['hidden_size'], kernel_size=5, dilation_rate=1, n_layers=hp['dec_layers'],
                        is_BTC=True),
}
